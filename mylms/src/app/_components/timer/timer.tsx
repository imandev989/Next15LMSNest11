...
//   const timeUnits = [
//     { show: seconds != null, unit: seconds, value: values.seconds, maxValue: maxValues.seconds, datePart: "seconds" },
//     { show: minutes != null, unit: minutes, value: values.minutes, maxValue: maxValues.minutes, datePart: "minutes" },
//     { show: showHours && hours != null, unit: hours, value: values.hours, maxValue: maxValues.hours, datePart: "hours" },
//     { show: showDays && days != null, unit: days, value: values.days, maxValue: maxValues.days, datePart: "days" },
//   ];
